from typing import *
import subprocess, re, os, datetime, argparse, sys, traceback, shutil
q = "'"
basefolder = 'C:/Backup'

# The following pattern matches with filenames that are already converted by the 'image_dater.py'
# script.
...
def parse_images(dirpath):
    '''
    Parse the given folder for images and move them.
    '''
    ...
    for filepath in filepath_list:
        ...
        if os.path.isfile(dst_filepath):
            ...
            while True:
                dst_filepath = str(
                    f'{dst_folderpath}/'
                    f'{date_to_str(filedate)}-{cntr:02d}.'
        ...
        # destination doesn't exist yet (the cntr has been taken care of). Move the file now.
